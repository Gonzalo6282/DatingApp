...
public class UsersController(IUserRepository userRepository, IMapper mapper) : BaseApiController //add BaseApiController and  inject DataContext class API.Data.DataContext 
{
